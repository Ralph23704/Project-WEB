 @extends('layouts.app')
    ...
    @section('content')
                ...
                <div class="col-9 scroller">
                    ...
                    <div class="row">
                        @foreach($events as $event)
                            <div class="thumbnail">
                                <img src="{{'img/'.$event->image}}" alt="..." class="Event">
                                <div class="caption">
                                    <h3>{{$event->name}}</h3>
                        ...
                        @foreach($activity as $act)
                            <li class="media activite" style="border-radius: 5px">
                                ...
                                <div class="media-body">
                                    ...
                                    {{$act->description}}
                                    <a href="#" class="btn btn-primary" role="button" style="float: right;"><i class="bi-heart" id="like"></i>{{$act->votes}} Votes</a>
                                </div>
                            </li>
                        @endforeach
                    </ul>
                    <div class="add_a_new_activity" style=" float: right; justify-content: center">
                        <a type="button" class="bi-plus" style="text-align: center"></a>
                    </div>
        ...
        <script>
            function like(){
                document.getElementById('like').className= 'bi-heart-fill';
            }
        </script>
